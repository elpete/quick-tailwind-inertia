        ...
        <div class="w-full max-w-lg bg-white px-8 pt-6 pb-8 mb-4 shadow-md rounded">
            ...
            <form @submit.prevent="submit">
                ...
                <div class="mb-6">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        :class="{ 'border-red-500 mb-3': $page.props.errors.passwordConfirmation }"
                        v-model="form.passwordConfirmation"
                        id="passwordConfirmation"
                        type="password"
                        placeholder="******************"
                    >
                    <p v-for="error in $page.props.errors.passwordConfirmation" class="text-red-500 text-xs italic">{{ error.message }}</p>
                </div>
